...
//    }
    ...
    private fun estrela(verticesVisitados: List<VerticeInfo>, verticesInfoSaidas: List<VerticeInfo>): List<Int> {
        try {
            ...
            val openList = PriorityQueue<Caminho> { a, b ->
                (a.custoAcumulado + heuristica(verticesVisitados.find { it.verticeAtual == a.vertice }, verticesInfoSaidas.firstOrNull())) -
                        (b.custoAcumulado + heuristica(verticesVisitados.find { it.verticeAtual == b.vertice }, verticesInfoSaidas.firstOrNull()))
            }
    ...
    // Função de heurística atualizada
    private fun heuristica(v: VerticeInfo?, objetivo: VerticeInfo?): Int {
